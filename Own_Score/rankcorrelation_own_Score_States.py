...
try:
    ...
    #swing = f"SELECT Machine_Score_1 FROM results WHERE State = 'California'"
    #swing = f"SELECT Machine_Score_1 FROM results WHERE Gender = '1'"
    cursor.execute(swing)
    nonSwing = f"SELECT Machine_Score_1 FROM results WHERE State = 'Ohio' OR State = 'Louisiana' OR State = 'California'"
    #nonSwing = f"SELECT Machine_Score_1 FROM results WHERE State = 'Georgia'"
    #nonSwing = f"SELECT Machine_Score_1 FROM results WHERE Gender = '2'"
