...
try:
    ...
    bmd = f"SELECT Machine_Score_1 FROM results WHERE Political_Leaning = '1'"
    cursor.execute(bmd)
    drewvvpat = f"SELECT Machine_Score_1 FROM results WHERE Political_Leaning = '2'"
    cursor2.execute(drewvvpat)
    drewovvpat = f"SELECT Machine_Score_1 FROM results WHERE Political_Leaning = '3'"
